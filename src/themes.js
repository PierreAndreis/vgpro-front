const Light = {
  ...
  gradient: {
    primary: "linear-gradient(-90deg, #FBAB7E 0%, #F7CE68 100%)",
    ...
    boxDividerBackground:
      "linear-gradient(to top, rgba(0,0,0,0.05) 0%,rgba(0,0,0,0) 100%)",
    skeleton:
      "linear-gradient(90deg,rgba(102, 107, 109, 0.192),rgba(184, 193, 197, 0.4),rgba(186, 194, 197, 0.2))",
  },
};
